...
import com.android.settings.aoscp.wifi.LongPressConnectedAPSignalPreference;
...
public class WifiSettings extends RestrictedSettingsFragment
    ...
    private ConnectedAPSignalPreference.UserBadgeCache mSignalUserBadgeCache;

    private PreferenceCategory mConnectedAPPreferenceCategory;
    ...
    private void addPreferences() {
        ...
        mConnectedAPPreferenceCategory =
        ...
        mSignalUserBadgeCache = new ConnectedAPSignalPreference.UserBadgeCache(getPackageManager());
    ...
    @NonNull
    private LongPressConnectedAPSignalPreference createConnectedAPSignalPreference(
            AccessPoint accessPoint) {
        return new LongPressConnectedAPSignalPreference(accessPoint, getPrefContext(), mSignalUserBadgeCache,
                false, this);
    }
    ...
    private boolean configureConnectedAccessPointPreferenceCategory(
        ...
        if (mConnectedAPPreferenceCategory.getPreferenceCount() == 0) {
        ...
        ConnectedAPSignalPreference preference = (ConnectedAPSignalPreference)
            (mConnectedAPPreferenceCategory.getPreference(0));
        ...
        ((LongPressConnectedAPSignalPreference) mConnectedAPPreferenceCategory.getPreference(0))
                .refreshMeter();
        return true;
    }
    ...
    private void setConnectedApHeader(AccessPoint connectedAp) {
        ...
        Drawable wifiIcon = getWifiIcon(
                iconSignalLevel, getContext().getTheme()).mutate();
     ...
     * {@link #mConnectedAPPreferenceCategory}.
     */
    private void addConnectedAccessPointPreference(AccessPoint connectedAp) {
        String key = connectedAp.getBssid();
        LongPressConnectedAPSignalPreference pref = (LongPressConnectedAPSignalPreference)
        ...
        mConnectedAPPreferenceCategory.addPreference(pref);
        mConnectedAPPreferenceCategory.setVisible(true);
        if (mClickedConnect) {
            mClickedConnect = false;
            scrollToPreference(mConnectedAPPreferenceCategory);
        }
    }

    /** Removes all preferences and hide the {@link #mConnectedAPPreferenceCategory}. */
    private void removeConnectedAccessPointPreference() {
        mConnectedAPPreferenceCategory.removeAll();
        mConnectedAPPreferenceCategory.setVisible(false);
    }
    ...
    private Drawable getWifiIcon(
            @IntRange(from=0, to=4) int signalLevel, @Nullable Theme theme) {
        return getContext().getResources().getDrawable(getWifiSignalResource(signalLevel), theme);
    }

    @DrawableRes
    private int getWifiSignalResource(int signalLevel) {
        switch (signalLevel) {
            case 0:
                return R.drawable.ic_settings_wifi_signal_0;
            case 1:
                return R.drawable.ic_settings_wifi_signal_1;
            case 2:
                return R.drawable.ic_settings_wifi_signal_2;
            case 3:
                return R.drawable.ic_settings_wifi_signal_3;
            case 4:
                return R.drawable.ic_settings_wifi_signal_4;
            default:
